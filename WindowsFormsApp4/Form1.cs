...
namespace WindowsFormsApp4
{
    public partial class Form1 : Form
    {
        ...
        private void cckatu_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void kakutei_Click(object sender, EventArgs e)
        {
            ...
            {
                keisankextuka("8401-9000/336.1-361HP(341.1-366.4PS)", "貨車", 13500);
            }

            else if (this.tukaikata.SelectedIndex == 1 && this.cckatu.SelectedIndex == 16)
            {
                keisankextuka("9001-9600", "貨車", 14400);
            }

            else if (this.tukaikata.SelectedIndex == 1 && this.cckatu.SelectedIndex == 17)
            {
                keisankextuka("9601-10200/361.1HP以上(366.5PS以上)", "貨車", 15300);
            }

            else if (this.tukaikata.SelectedIndex == 1 && this.cckatu.SelectedIndex == 18)
            {
                keisankextuka("10201以上", "貨車", 16200);
            }

            if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 0)
            {
                keisankextuka("600以下", "大客車", 1080);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 1)
            {
                keisankextuka("601-1200", "大客車", 1800);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 2)
            {
                keisankextuka("1201-1800", "大客車", 2700);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 3)
            {
                keisankextuka("1801-2400", "大客車", 3600);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 4)
            {
                keisankextuka("2401-3000/138HP以下(140.1PS以下)", "大客車", 4500);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 5)
            {
                keisankextuka("3001-3600", "大客車", 5400);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 6)
            {
                keisankextuka("3601-4200/138.1-200HP(140.2-203.0PS)", "大客車", 6300);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 7)
            {
                keisankextuka("4201-4800", "大客車", 7200);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 8)
            {
                keisankextuka("4801-5400/200.1-247HP(203.1-250.7PS", "大客車", 8100);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 9)
            {
                keisankextuka("5401-6000", "大客車", 9000);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 10)
            {
                keisankextuka("6001-6600/247.1-286HP(250.8-290.3PS)", "大客車", 9900);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 11)
            {
                keisankextuka("6601-7200", "大客車", 10800);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 12)
            {
                keisankextuka("7201-7800/286.1-336HP(290.4-341.0PS)", "大客車", 11700);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 13)
            {
                keisankextuka("7801-8400", "大客車", 12600);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 14)
            {
                keisankextuka("8401-9000/336.1-361HP(341.1-366.4PS)", "大客車", 13500);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 15)
            {
                keisankextuka("9001-9600", "大客車", 14400);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 16)
            {
                keisankextuka("9601-10200/361.1HP以上(366.5PS以上)", "大客車", 15300);
            }

            else if (this.tukaikata.SelectedIndex == 2 && this.cckatu.SelectedIndex == 17)
            {
                keisankextuka("10201以上", "大客車", 16200);
            }

            if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 0)
            {
                keisankextuka("500以下/38HP以下(38.6PS以下)", "自用小客車", 1620);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 1)
            {
                keisankextuka("501~600/38.1-56HP(38.7-56.8PS)", "自用小客車", 2160);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 2)
            {
                keisankextuka("601-1200/56.1-83HP(56.9-84.2PS)", "自用小客車", 4320);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 3)
            {
                keisankextuka("1201-1800/83.1-182HP(84.3-184.7PS)", "自用小客車", 7120);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 4)
            {
                keisankextuka("1801-2400/182.1-262HP(184.8-265.9PS)", "自用小客車", 11230);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 5)
            {
                keisankextuka("2401-3000/262.1-322HP(266-326.8PS)", "自用小客車", 15210);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 6)
            {
                keisankextuka("3001-4200/322.1-414HP(326.9-420.2PS)", "自用小客車", 28220);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 7)
            {
                keisankextuka("4201-5400/414.1-469HP(420.3-476.0PS)", "自用小客車", 46170);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 8)
            {
                keisankextuka("5401-6600/469.1-509HP(476.1-516.6PS)", "自用小客車", 69690);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 9)
            {
                keisankextuka("6601-7800/509.1HP以上(516.7PS以上)", "自用小客車", 117000);
            }

            else if (this.tukaikata.SelectedIndex == 3 && this.cckatu.SelectedIndex == 10)
            {
                keisankextuka("7801以上", "自用小客車", 151200);
            }

            if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 0)
            {
                keisankextuka("500以下/38HP以下(38.6PS以下)", "營業用小客車", 900);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 1)
            {
                keisankextuka("501-600/38.1-56HP(38.7-56.8PS)", "自用小客車", 1260);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 2)
            {
                keisankextuka("601-1200/56.1-83HP(56.9-84.2PS)", "自用小客車", 2160);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 3)
            {
                keisankextuka("1201-1800/83.1-182HP(84.3-184.7PS)", "自用小客車", 3060);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 4)
            {
                keisankextuka("1801-2400/182.1-262HP(184.8-265.9PS)", "自用小客車", 6480);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 5)
            {
                keisankextuka("2401-3000/262.1-322HP(266-326.8PS)", "自用小客車", 9900);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 6)
            {
                keisankextuka("3001-4200/322.1-414HP(326.9-420.2PS)", "自用小客車", 16380);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 7)
            {
                keisankextuka("4201-5400/414.1-469HP(420.3-476.0PS)", "自用小客車", 24300);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 8)
            {
                keisankextuka("5401-6600/469.1-509HP(476.1-516.6PS)", "自用小客車", 33660);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 9)
            {
                keisankextuka("6601-7800/509.1HP以上(516.7PS以上)", "自用小客車", 44460);
            }

            else if (this.tukaikata.SelectedIndex == 4 && this.cckatu.SelectedIndex == 10)
            {
                keisankextuka("7801以上", "自用小客車", 56700);
            }
